...
public class SensorCreateDialog extends JDialog {
	...
	public static void main(String[] args) {
		try {
			SensorCreateDialog dialog = new SensorCreateDialog(null);
	 ...
	 * Create the dialog.
	 */
	public SensorCreateDialog(Frame fen) {
		...
		{
			lblEnergie = new JLabel("Energie");
			sl_contentPanel.putConstraint(SpringLayout.NORTH, lblEnergie, 10, SpringLayout.NORTH, contentPanel);
			sl_contentPanel.putConstraint(SpringLayout.WEST, lblEnergie, 0, SpringLayout.WEST, lblCoordonneeX);
			contentPanel.add(lblEnergie);
		}
		{
			energieTextField = new JTextField();
			sl_contentPanel.putConstraint(SpringLayout.NORTH, energieTextField, 0, SpringLayout.NORTH, lblEnergie);
			sl_contentPanel.putConstraint(SpringLayout.EAST, energieTextField, 0, SpringLayout.EAST, PosxTextField);
			contentPanel.add(energieTextField);
			energieTextField.setColumns(10);
		}
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				final SensorCreateDialog dialog=this;
				okButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						sensor.setPower(Integer.valueOf(dialog.energieTextField.getText()));
						sensor.setPosition(new Position(Integer.valueOf(dialog.PosxTextField.getText()),Integer.valueOf(dialog.PosytextField.getText())));
						sensor.setRadius(Integer.valueOf(dialog.rayontextField.getText()));
						sensor.setFrame(fen);
						sensor.on();
						Frame.getNetwork().addSensor(sensor);
